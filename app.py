...
if __name__ == '__main__':
    # Render provides the PORT environment variable. If that port is already in use,
    # fall back to the next available port so local runs do not crash.
    requested_port = int(os.environ.get("PORT", 10000))
    port = find_available_port(start_port=requested_port, max_attempts=20)
    import uvicorn
