...
```
https://noise-monitoring-backend.onrender.com
```
...
```bash
# Test health check
curl https://noise-monitoring-backend.onrender.com/api/classes

# Test prediction (with audio file)
curl -X POST -F "file=@test_audio.wav" https://noise-monitoring-backend.onrender.com/api/predict
```
